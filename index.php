...
function createAccount()
{
    ...
    echo "<td> $age </td>";
    echo "<td> $email </td>";
    echo "<td><a href=\"view.php\"><i class=\"bi bi-eye text-light bg-dark p-1\"></i></a> <a href=\"update.php\"> <i class=\"bi bi-pencil-square text-light bg-primary p-1\"></i></a> <a href=\"index.php\"><i class=\"bi bi-trash3 text-light bg-danger p-1\" id=\"delete\" name=\"delete\"></i></a></td>";
    echo "</tr>";
}
